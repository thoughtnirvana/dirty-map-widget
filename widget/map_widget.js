...
(function() {
  ...
  $.fn.extend({
    mapList: function(data) {
      var LatLng, bounds, i, infoString, infoWindow, map, mapOptions, marker, pos, _i, _ref;
      ...
      for (i = _i = 0, _ref = data.length - 1; 0 <= _ref ? _i <= _ref : _i >= _ref; i = 0 <= _ref ? ++_i : --_i) {
        ...
        marker.setMap(map);
        google.maps.event.addListener(marker, 'click', (function(marker, infoString, infoWindow) {
          return function() {
            infoWindow.setContent(infoString);
            return infoWindow.open(map, marker);
          };
        })(marker, infoString, infoWindow));
        bounds.extend(pos);
      }
